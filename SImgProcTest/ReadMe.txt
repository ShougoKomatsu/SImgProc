================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: SImgProcTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した SImgProcTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには SImgProcTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

SImgProcTest.vcxproj
...
SImgProcTest.h
   ...
   CSImgProcTestApp アプリケーション クラスを宣言します。

SImgProcTest.cpp
   これは、アプリケーション クラス CSImgProcTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\SImgProcTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル SImgProcTest.rc に含まれていま
   す。

res\SImgProcTest.rc2
...
SImgProcTestDlg.h, SImgProcTestDlg.cpp - ダイアログ
   これらのファイルは CSImgProcTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な SImgProcTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   SImgProcTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
